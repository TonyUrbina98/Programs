...
/*
There is a problem with this funciton, so you would need to add another global variable.
Then you would need to check that under the else statement so it stores the value in the new variable.
Finally you need to switch the - s to - new variable.
*/
