...
public int overallScore()
{
   ...
   if (score1 < score2 && score1 < score3) {
      ...
      s1 = score1;
      s2 = score3;//fixed the value from score2 to score3 since 2 is the smallest
...
{
   int s1, s2, s3;
   if (args.length != 3) {//removed args==null because it is hard to test that doing build file 
